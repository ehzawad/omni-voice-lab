# Vendored from pipecat-ai/pipecat (BSD-2-Clause), src/pipecat/audio/turn/smart_turn/_whisper_features.py.
# Kept byte-identical so Smart Turn v3 sees exactly the features it was trained on.
#
